...
public class ModArmorMaterials {
    public static final Holder<ArmorMaterial> ADAMANTIUM_ARMOR_MATERIAL = register("adamantium",
            ...
            }), 10, 3f, 0.0f, () -> ModItems.ADAMANTIUM.get());
    public static final Holder<ArmorMaterial> ADAMANTIUM_NETHERITE_ARMOR_MATERIAL = register("adamantium_netherite",
            Util.make(new EnumMap<>(ArmorItem.Type.class), attribute -> {
            ...
            }), 25, 5f, 0.2f, () -> ModItems.ADAMANTIUM_NETHERITE_CLUSTER.get());


    private static Holder<ArmorMaterial> register(String name, EnumMap<ArmorItem.Type, Integer> typeProtection,
                                                  int enchantability, float toughness, float knockbackResistance,
                                                  Supplier<Item> ingredientItem) {
        ResourceLocation location = ResourceLocation.fromNamespaceAndPath(TheForgottenExpance.MODID, name);
