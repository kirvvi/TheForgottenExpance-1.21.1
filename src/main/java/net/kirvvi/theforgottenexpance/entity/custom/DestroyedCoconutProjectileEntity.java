...
public class DestroyedCoconutProjectileEntity extends AbstractArrow {

    public DestroyedCoconutProjectileEntity(EntityType<? extends AbstractArrow> entityType, Level level) {
        super(entityType, level);
    }

    public DestroyedCoconutProjectileEntity(LivingEntity shooter, Level level) {
        super(ModEntities.DESTROYED_COCONUT.get(), shooter, level, new ItemStack(ModItems.DESTROYED_COCONUT.get()), null);
    }

    @Override
    protected ItemStack getDefaultPickupItem() {
        return new ItemStack(ModItems.DESTROYED_COCONUT.get());
    }
            ...
            if (isDropable) {
                ...
                if (this.level().getBlockState(placePos.below()).isAir()) {
                    ...
                    if (chance < 0.8) {
                        ...
                        this.spawnAtLocation(ModItems.COCONUT_OPENED_CLEAN.get());
                        this.spawnAtLocation(ModItems.COCONUT_OPENED.get());
                    }
