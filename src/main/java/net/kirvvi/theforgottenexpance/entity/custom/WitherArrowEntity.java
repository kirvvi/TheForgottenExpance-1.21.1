...
public class WitherArrowEntity extends AbstractArrow {
        private static final int EXPOSED_POTION_DECAY_TIME = 600;
        private static final int NO_EFFECT_COLOR = -1;
        private static final EntityDataAccessor<Integer> ID_EFFECT_COLOR = SynchedEntityData.defineId(WitherArrowEntity.class, EntityDataSerializers.INT);
        private static final byte EVENT_POTION_PUFF = 0;

    public WitherArrowEntity(EntityType < ? extends WitherArrowEntity > entityType, Level level){
        super(entityType, level);
    }
    public WitherArrowEntity(Level level, LivingEntity shooter) {
        super(ModEntities.WITHER_ARROW.get(), shooter, level, new ItemStack(ModItems.WITHER_ARROW.get()), null);
    }

    public WitherArrowEntity(Level level, double x, double y, double z, ItemStack pickupItemStack, @Nullable ItemStack
        firedFromWeapon){
        super(ModEntities.WITHER_ARROW.get(), x, y, z, level, pickupItemStack, firedFromWeapon);
        this.updateColor();
    }

    public WitherArrowEntity(Level level, LivingEntity owner, ItemStack pickupItemStack, @Nullable ItemStack firedFromWeapon) {
        super(ModEntities.WITHER_ARROW.get(), owner, level, pickupItemStack, firedFromWeapon);
        this.updateColor();
    }
        ...
        if (this.level().isClientSide) {
            ...
            this.setPickupItemStack(new ItemStack(ModItems.WITHER_ARROW.get()));
        }
    }
        ...
        return new ItemStack(ModItems.WITHER_ARROW.get());
    }
        @Override
