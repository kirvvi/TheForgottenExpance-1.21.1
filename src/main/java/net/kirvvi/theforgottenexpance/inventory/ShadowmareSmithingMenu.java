package net.kirvvi.theforgottenexpance.inventory;
...
public class ShadowmareSmithingMenu extends ItemCombinerMenu {
    ...
    public ShadowmareSmithingMenu(int containerId, Inventory playerInventory) {
        this(containerId, playerInventory, ContainerLevelAccess.NULL);
    }

    public ShadowmareSmithingMenu(int containerId, Inventory playerInventory, ContainerLevelAccess access) {
    ...
    protected boolean isValidBlock(BlockState state) {
        return state.is(Blocks.SMITHING_TABLE); // Измените блок на ваш, если нужно
    }
